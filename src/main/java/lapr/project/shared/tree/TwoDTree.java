...
public class TwoDTree  {
    ...
    public void insert(Port port){ root = insert(new Node(port, null,null), root, true);}
  ...
  /*  public double distanceOfAPoint(double x, double y) {
    ...
    public Node nearesNeighbor(Port target){ Node n = nearestNeighbor(root,target,true);
                                             return n;}
    ...
    public String toString() {
        ...
        while (!q.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                Node n = q.poll();
                if (n != null) {
                    sb.append("(").append(n.getElement().getLocation().getLongitude()).append(", ").append(n.getElement().getLocation().getLatitude()).append(")");
                    q.add(n.left);
                    q.add(n.right);
                } else {
                    sb.append("null, ");
