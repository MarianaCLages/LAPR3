...
public class AverageCargoByYearController {
     ...
     */
    public String averageCargoByYear(int mmsi, int year) throws NoCargoManifestInThatDateException, NoCargoManifestsWereFoundInThatTripException, SQLException, NoContainersInsideThatTripException {
